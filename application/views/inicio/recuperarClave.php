...
<div class="center-form-large " style=" width:60%; ">
    ...
    <div class="p-3 col-sm-12 bg-light text-dark ">
        <form class="needs-validation" method="post" autocomplete="off"
            action="<?php echo site_url('iniciocertificados/verificarClave'); ?>" novalidate>
     ...
     <div class="col-md-6">
       ...
       <input value="<?php if($idAportante != "") {echo $idAportante;} else { echo "";}  ?>" onkeypress='return validaNumericos(event)' type="text" class="form-control" id="idAportante" name="idAportante" placeholder="Digite Número de Identificación" required>
        ...
        <div class="form-row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
              ...
              <input value="<?php if($correo != "") {echo $correo;} else { echo "";}  ?>" type="email" class="form-control" name="correo" id="correo" placeholder="Digite Correo de la empresa"
                    ...
                    <center>
                        <div class="btn-group">
                            ...
                            <div class="col-sm"> <button id="validar" class="btn btn-primary btn-sm"
                                    type="submit">Recuperar</button></div>
...
<script>
 ...
 function aceptar() {
    ...
    if (codigo == '') {
        ...
        //   $(this).data("count", i);
        // console.log(i);
        if (codigo == validacion) {var contante = '';}else{
        var contante = 1;}
        $.ajax({
